...
import { ProfessionalStudentContact } from './contact/page'

export default function LandingPag1() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-white text-gray-800">
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10 min-w-[800px] w-[400px] text-black drop-shadow-lg -mt-[100px] hidden md:block">
            <h2 className="text-5xl font-normal text-start -mr-[50px]">
              We ignite inspiration & Add
            </h2>
            <div className="-mt-2">
              <TypewriterEffect words={[{
                text: "Dimension",
                className: "text-black text-[80px] md:text-[150px]",
              }]} />
            </div>
            <h2 className="text-4xl font-normal -mt-4 text-end">
              to your vision
            </h2>
          </div>
          <div className="relative z-10 text-black text-center px-4 md:hidden">
            <p className="text-sm mb-[-5px]">We ignite inspiration & Add</p>
            <div className="-mt-1">
              <TypewriterEffect words={[{
                text: "Dimension",
                className: "text-black text-[80px] md:text-[150px]",
            ...
            <p className="text-sm -mt-2">to your vision</p>
          </div>
          <div className="absolute right-4 top-1/2 w-1 h-32 bg-gray-300 hidden md:block">
            <div className="w-full h-8 bg-red-600"></div>
          </div>
        </motion.section>
        ...
        >
          <p>
            <span className="text-red-600 font-semibold">4D in Spotlight:</span>{" "}
            4D Architect won the prestigious title of IDA ...
          </p>
        </motion.section>
